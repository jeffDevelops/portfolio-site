    ...
    sass: {                              // Task
      expanded: {                            // Target
        ...
        files: {
          ...
          'css/customstyles.css': 'sass/customstyles.scss'
        }
      },
      ...
      min: {
        ...
        files: {
          ...
          'css/customstyles.min.css': 'sass/customstyles.scss'
        }
      },
    },
...
//  Notifications
  ...
  grunt.registerTask('sass_compile', ['sass:min', 'sass:expanded', 'postcss:min', 'postcss:expanded']);
